(defun C:bduzf ()
  ...
  (setq A (ssget "X" '((0 . "LWPOLYLINE,INSERT"))))       ;"A"=list of cirlces, polylines, blocks
  ...
  (repeat n (ssadd (ssname B (setq i (1+ i))) A))      ;appedelets ID of element referenced by i in list Bs to list A
